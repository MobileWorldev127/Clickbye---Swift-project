...
open class  ISRadioButton: UIButton {
    ...
    open var setMultipleSelectionEnabled:Bool {
    ...
    open func selectedButton() -> ISRadioButton!{
    ...
    open func selectedButtons() -> NSMutableArray{
    ...
    open func deselectOtherButtons() {
        if self.otherButtons != nil {
            for isRadioButton in self.otherButtons!  {
    ...
    open func unSelectedButtons() -> NSArray{
