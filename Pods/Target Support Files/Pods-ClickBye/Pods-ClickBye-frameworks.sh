...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/Apptimize/apptimize-ios-2.18.2/Apptimize.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/Segment-Apptimize/Segment_Apptimize.framework"
